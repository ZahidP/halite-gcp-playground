...
class HaliteAgent:
    ...
    def __init__(self,
                 ...
                 ship_state_wrapper=None,
                 shipyard_state_wrapper=None
                 ):
    ...
    def get_single_shipyard_move(self,
        ...
        # Select action
        converted_observation = self.env.wrap_observation_for_shipyard_agent(
